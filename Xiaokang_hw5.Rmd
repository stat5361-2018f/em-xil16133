...
Then by taking first order derivative of funtion $Q(\Psi|\Psi^{k+1})$ with respect to $\{\pi_j\}$, $\beta_j,j=1,\ldots,m$ and $\sigma^2$ seperately, and set them to be 0, we can get the MLE of these parameters. 
